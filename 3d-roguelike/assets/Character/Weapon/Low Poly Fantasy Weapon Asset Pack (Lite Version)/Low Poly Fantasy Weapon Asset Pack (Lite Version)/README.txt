Thank you for downloading the Low-Poly Fantasy Weapon Asset Pack (Lite Version) by Game Dev Skill Up!

In order to use the models, just extract the zip file in a suitable location.

Please note that this is the lite version of the asset pack, and only includes 5 of the 15 weapons
included in the pack which are the: Broad Sword, Round Shield, Axe, Club and Bow. If you would like
access to all 15 weapons, you can buy the full version on the same game page.
